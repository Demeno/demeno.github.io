...
(function (Taxidentville) {
    class Slide {
        constructor(slideId, slideManager) {
    ...
    class Slide1 extends Slide {
        constructor(slideManager) {
            ...
            this.continueButton = document.getElementById("slide1-continue-button");
            this.slide1Text1 = document.getElementById("slide1-text1");
            this.slide1Text2 = document.getElementById("slide1-text2");
            this.slide1Text2DynamicParagaraph = document.getElementById("slide1Text2DynamicParagaraph");
        ...
        goToState2(selectedPercent) {
            ...
            // @ts-ignore
            gtag('event', 'question_selected_percent', { value: selectedPercent });
        }
    ...
    class Slide2 extends Slide {
        constructor(slideManager) {
            ...
            this.continueButton = document.getElementById("slide2-continue-button");
            this.continueButton.addEventListener("click", (ev) => {
                this.finishSlide();
            });
        }
        enter() {
            this.cabSliderController = new Taxidentville.CabSliderController("slide2-cabs-slider", 1, (newValue) => {
                if (newValue == 6) {
    ...
    Taxidentville.Slide2 = Slide2;
    class Slide3 extends Slide {
        constructor(slideManager) {
            super("slide3", slideManager);
            const shuffleAccidentButton = document.getElementById("slide3-shuffle-accident-button");
            const placeAccidentButton = document.getElementById("slide3-place-accident-button");
            ...
            const shuffleCabsButton = document.getElementById("slide3-shuffle-cabs-button");
            const placeCabsButton = document.getElementById("slide3-place-cabs-button");
        ...
        enter() {
            this.clearAccidentStats();
            this.cabSliderController = new Taxidentville.CabSliderController("slide3-cabs-slider", 6, (newValue) => {
                this.mapController.setCabColorsByValue(newValue);
            });
            this.mapController = new Taxidentville.MapController("taxidentville-graphics-container", (wasAccidentBlue) => this.onAccident(wasAccidentBlue));
            super.show();
        }
        leave() {
            super.hide();
    ...
    class Slide4 extends Slide {
        ...
        enter() {
            this.cabSliderController = new Taxidentville.CabSliderController("slide4-cabs-slider", 0, null);
            this.cabSliderController.setIsDisabled(true);
            this.witnessSliderController = new Taxidentville.WitnessSliderController("slide4-witness-slider", 6, null);
    ...
    class Slide5 extends Slide {
        ...
        enter() {
            ...
            const startCabs = 0;
            const startRight = 6;
            this.cabSliderController = new Taxidentville.CabSliderController("slide5-cabs-slider", startCabs, () => this.onSlidersChanged());
            this.witnessSliderController = new Taxidentville.WitnessSliderController("slide5-witness-slider", startRight, () => this.onSlidersChanged());
            this.witnessCabsController = new Taxidentville.WitnessCabsController("slide5-witness-cabs", startCabs, startRight);
            super.show();
        }
        leave() {
            super.hide();
    ...
    class Slide6 extends Slide {
        ...
        enter() {
            ...
            this.cabSliderController = new Taxidentville.CabSliderController("slide6-cabs-slider", startCabSliderValue, () => this.onSlidersChanged());
            this.witnessSliderController = new Taxidentville.WitnessSliderController("slide6-witness-slider", 8, () => this.onSlidersChanged());
            this.mapController = new Taxidentville.MapController("phase6-taxidentville-graphics-container", null);
            setTimeout(() => {
